      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-16">
          ...
          >
            ...
            <div className="flex items-center justify-center md:justify-start gap-3 sm:gap-4 w-full">
              <button
                onClick={saveContact}
                className="inline-flex flex-1 md:flex-none items-center justify-center gap-1 sm:gap-2 bg-gold-gradient px-3 sm:px-6 py-3 rounded-full text-primary-foreground font-body font-semibold text-xs sm:text-sm md:text-base whitespace-nowrap hover:opacity-90 transition-opacity shadow-lg"
              >
              ...
              >
                Fale Conosco
                <svg width="16" height="16" className="sm:w-[18px] sm:h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M19 12l-7 7-7-7"/></svg>
              </a>
            </div>
          </motion.div>
